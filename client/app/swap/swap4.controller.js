      ...
      $http(req).then(response => {
        ...
        var data = {
          ...
          "args": {
            ...
            //,
            //"oracleAddress": $scope.contactContract.oracleAddress
          },
          "contract": "Contact"
        };
        ...
        var req = {
         method: 'POST',
         url: appConfig.keyserver + 'users/' + localStorageService.get('user')+ '/'+ localStorageService.get('address') + '/contract/Contact/' + $scope.newContract + '/call',
         headers: {
           'Content-Type': 'application/json'
         },
