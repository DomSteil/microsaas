    ...
    $scope.submit = function(){
      ...
      $http(req).then(response => {
        ...
        var data = {
          ...
          "args": {
            "quoteName": $scope.quoteContract.quoteName,
			"quotePrice": $scope.quoteContract.quotePrice,
			"products": $scope.quoteContract.products
			
			
            //,
            //"oracleAddress": $scope.quoteContract.oracleAddress
          },
          "contract": "Quote"
        };
        ...
        var req = {
         method: 'POST',
         url: appConfig.keyserver + 'users/' + localStorageService.get('user')+ '/'+ localStorageService.get('address') + '/contract/Quote/' + $scope.newContract + '/call',
         headers: {
           'Content-Type': 'application/json'
         },
...
angular.module('microsaas')
  .controller('Swap5Controller', Swap5Controller);
