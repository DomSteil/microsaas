  ...
  constructor($http, $stateParams, $scope, appConfig, cfpLoadingBar, localStorageService, $interval, ngToast) {
    ...
    $scope.createQuote = function() {
      ...
      var data = {
        ...
        "method": "buyerAcceptsQuoteContract",
        "args": {},
        "contract": "Quote",
        "value": $scope.contractState.quotePrice
      };
      var req = {
       method: 'POST',
       url: appConfig.keyserver + 'users/' + localStorageService.get('user')+ '/'+ localStorageService.get('address') + '/contract/Quote/' + $stateParams.id + '/call',
       headers: {
